 ...
 */
final class Version20220301235023 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE venta CHANGE comentario comentario LONGTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE venta CHANGE articulos articulos LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:object)\', CHANGE comentario comentario LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
